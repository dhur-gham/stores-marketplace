 ...
 *
 * Deploy this file to: https://yourdomain.com/tele/telegram_bot.php
 * Set webhook URL in Telegram: https://api.telegram.org/bot<TOKEN>/setWebhook?url=https://yourdomain.com/tele/telegram_bot.php
 */
